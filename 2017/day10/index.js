...
function getFirstResult(l, input) {

    let [list] = getHash([...Array(l).keys()], input.split(',').map(Number), 0, 0)
    return list[0] * list[1]
}

function getSecondResult(l, n) {
...
const result1 = getFirstResult(256, input);
const result2 = getSecondResult(256, input)
